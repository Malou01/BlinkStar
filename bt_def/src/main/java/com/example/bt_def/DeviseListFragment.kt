...
class DeviceListFragment : Fragment(), ItemAdapter.Listener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.done.setOnClickListener {
            Snackbar.make(binding.root, "Нажата!", Snackbar.LENGTH_LONG).show()
    ...
    private fun getPairedDevices(){
        try {
            ...
            //binding.done.visibility = if(list.isEmpty()) View.VISIBLE else View.GONE
            /*if(list.isEmpty()){
                binding.tvEmptyPaired.visibility = View.VISIBLE
                binding.done.visibility = View.VISIBLE
            } else {
                binding.tvEmptyPaired.visibility = View.GONE
